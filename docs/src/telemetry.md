...
Open Zed's Settings editor with `⌘,` (or `⌘⇧P` → "Open Settings") and navigate to the **Privacy** section to toggle telemetry on or off. You can also configure this manually in your `settings.json`:
